...
from fastapi.security import OAuth2PasswordBearer, HTTPBearer, HTTPAuthorizationCredentials # gives you a standard way to extract the token from a request's Authorization header
